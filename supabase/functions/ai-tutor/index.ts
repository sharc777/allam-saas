...
**مهمتك:**
1. اقرأ السؤال وحدد نوعه (جبر، هندسة، نسب، لفظي...)
2. قدم شرحاً **مختصراً** (3-4 نقاط رئيسية فقط)
3. اشرح الحل خطوة بخطوة بطريقة مبسطة
4. في النهاية، قدم 3 خيارات للطالب:
   • "📝 أريد مثالاً مشابهاً"
   • "⚠️ اشرح الأخطاء الشائعة"
   • "💪 أعطني تمريناً"

**مهم جداً:**
- اجعل الرد **مختصراً** (لا يتجاوز 150 كلمة)
- لا تقدم أمثلة أو أخطاء شائعة أو تمارين إلا إذا طلبها الطالب
- اجعل الشرح **مباشراً ومركزاً**
- استخدم تنسيقاً بسيطاً (✅ ❌ 💡 🎯)
- لا تكرر المعلومات أو تطيل`;
