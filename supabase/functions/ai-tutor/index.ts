...
ابدأ بشرح الموضوع بطريقة بسيطة وواضحة.`;
      ...
      systemPrompt += `\n\n**🎯 أنت الآن في وضع "المساعدة الفورية - شرح شامل للسؤال"**

عندما يسألك الطالب عن سؤال معين، اتبع هذا النهج الشامل:

**1️⃣ اقرأ وحلل السؤال:**
   - حدد نوع السؤال (جبر، هندسة، نسب وتناسب، لفظي، إلخ)
   - اذكر المفهوم الأساسي المطلوب
   - حدد مستوى الصعوبة

**2️⃣ اشرح السؤال خطوة بخطوة:**
   أ) ابدأ بتحديد المعطيات بوضوح
   ب) وضح المطلوب إيجاده بالضبط
   ج) اذكر القانون أو القاعدة المستخدمة
   د) احسب الحل خطوة بخطوة مع شرح كل خطوة
   هـ) أكد الإجابة النهائية

**3️⃣ قدم 2-3 أمثلة مشابهة:**
   
   **مثال سهل:** (نفس المفهوم، أرقام أبسط)
   - اكتب السؤال
   - اشرح الحل بإيجاز
   
   **مثال متوسط:** (نفس المفهوم، تعقيد أكبر قليلاً)
   - اكتب السؤال
   - اشرح الحل
   
   **مثال متقدم (اختياري):** (نفس المفهوم + خطوة إضافية)
   - اكتب السؤال
   - اشرح الحل

**4️⃣ اشرح الأخطاء الشائعة:**
   - ⚠️ الخطأ الأول: [اذكر الخطأ الشائع وكيفية تجنبه]
   - ⚠️ الخطأ الثاني: [اذكر خطأ آخر]
   - ⚠️ الخطأ الثالث: [إن وجد]
   - ✅ نصائح للتحقق من الإجابة

**5️⃣ تمرين تطبيقي:**
   - اطرح سؤالاً تدريبياً مشابهاً للطالب
   - انتظر إجابته
   - صحح وعلق على الإجابة بتفصيل

**مهم جداً:**
- استخدم تنسيقاً واضحاً مع الأيقونات (✅ ⚠️ 📝 🎯)
- اشرح بلغة بسيطة وواضحة
- قدم أمثلة عملية من الحياة اليومية عند الإمكان
- شجع الطالب على التفكير النقدي`;
...
**الموضوع:** ${currentQuestion.subject || currentQuestion.section || 'غير محدد'}
${currentQuestion.user_answer ? `\n**إجابة الطالب:** ${currentQuestion.user_answer} ${currentQuestion.user_answer !== currentQuestion.correct_answer ? '❌ (خاطئة)' : '✅ (صحيحة)'}` : ''}
${currentQuestion.correct_answer ? `\n**الإجابة الصحيحة:** ${currentQuestion.correct_answer}` : ''}
${currentQuestion.explanation ? `\n**الشرح الموجود:** ${currentQuestion.explanation}` : ''}

الآن، قدم شرحاً شاملاً وتفصيلياً باتباع الخطوات الخمس أعلاه.`;
      }
    }
